...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (profilePic) {
        const storageRef = ref(getStorage(), `profile_pics/${profilePic.name}`);
        await uploadBytes(storageRef, profilePic);
        profilePicUrl = await getDownloadURL(storageRef);
      }

      // Add the new faculty member to the 'faculty' collection
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Sign Up to get access to the seamless dashboard.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Ultimate Solution</span>
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      <svg
                        ...
                        id="PhoneIcon"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 329.276 329.276"
                        xml:space="preserve"
                        className="fill-current"
                      >
                        <g>
                          <path d="M321.776,68.693h-98.138c-4.142,0-7.5,3.357-7.5,7.5s3.358,7.5,7.5,7.5h90.638v189.391H15V83.693h110.888v10 c0,4.143,3.358,7.5,7.5,7.5h62.5c4.142,0,7.5-3.357,7.5-7.5v-45c0-4.143-3.358-7.5-7.5-7.5h-62.5c-4.142,0-7.5,3.357-7.5,7.5v20 H7.5c-4.142,0-7.5,3.357-7.5,7.5v204.391c0,4.143,3.358,7.5,7.5,7.5h314.276c4.142,0,7.5-3.357,7.5-7.5V76.193 C329.276,72.05,325.918,68.693,321.776,68.693z M140.888,56.193h47.5v30h-47.5V56.193z" />
                          <path d="M36.779,243.273c-4.142,0-7.5,3.357-7.5,7.5s3.358,7.5,7.5,7.5h117.083c4.142,0,7.5-3.357,7.5-7.5V133.69 c0-4.143-3.358-7.5-7.5-7.5H36.779c-4.142,0-7.5,3.357-7.5,7.5v73.948c0,4.143,3.358,7.5,7.5,7.5s7.5-3.357,7.5-7.5V141.19h102.083 v102.083H36.779z" />
                          <path d="M213.029,141.19h80.333c4.142,0,7.5-3.357,7.5-7.5s-3.358-7.5-7.5-7.5h-80.333c-4.142,0-7.5,3.357-7.5,7.5 S208.887,141.19,213.029,141.19z" />
                          <path d="M213.029,180.217h80.333c4.142,0,7.5-3.357,7.5-7.5s-3.358-7.5-7.5-7.5h-80.333c-4.142,0-7.5,3.357-7.5,7.5 S208.887,180.217,213.029,180.217z" />
                          <path d="M213.029,219.245h80.333c4.142,0,7.5-3.357,7.5-7.5s-3.358-7.5-7.5-7.5h-80.333c-4.142,0-7.5,3.357-7.5,7.5 S208.887,219.245,213.029,219.245z" />
                          <path d="M213.029,258.273h80.333c4.142,0,7.5-3.357,7.5-7.5s-3.358-7.5-7.5-7.5h-80.333c-4.142,0-7.5,3.357-7.5,7.5 S208.887,258.273,213.029,258.273z" />
                        </g>
                      </svg>
                    </span>
                  </div>
